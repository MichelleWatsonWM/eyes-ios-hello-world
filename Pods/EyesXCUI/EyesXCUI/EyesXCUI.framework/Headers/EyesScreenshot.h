 ...
 */
- (EyesScreenshot *)cropRegion:(Region *)region scale:(CGFloat)scaleRatio;
...
/**
 ...
 @param scaleRatio The ratio of device or image.
 */
- (EyesScreenshot *)cropStatusBarWithHeight:(CGFloat)statusBarHeight scale:(CGFloat)scaleRatio;
